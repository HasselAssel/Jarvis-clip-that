...
use ffmpeg_next::sys::av_buffer_unref;
use ffmpeg_next::sys::av_hwdevice_ctx_alloc;
use ffmpeg_next::sys::av_hwdevice_ctx_init;
use ffmpeg_next::sys::av_hwframe_ctx_alloc;
use ffmpeg_next::sys::av_hwframe_ctx_init;
use ffmpeg_next::sys::AVHWDeviceContext;
use ffmpeg_next::sys::AVHWDeviceType;
use ffmpeg_next::sys::AVHWFramesContext;
...
impl D3d11EncoderHwContext for D3d11vaAdapter {
    fn setup_hw_and_frame_ctx(
        ...
        if hw_device_ctx.is_null() {
            //"Failed to allocate HW device context"
